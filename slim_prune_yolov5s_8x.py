...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov5l_v6_hand.cfg', help='cfg file path')
    ...
    parser.add_argument('--weights', type=str, default='weights/last_v6l.pt', help='sparse model weights')
